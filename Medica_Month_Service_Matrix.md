...
| **M5** | · | 3 | 2 | · | 23 | 2 | · | · | 4 | · | · | 4 | · | 21 | · | 20 | · | 7 | · | · | 1 | · | · | **87** |
| **M6** | · | 12 | 2 | 4 | · | 3 | 13 | · | · | 2 | · | · | · | 8 | 16 | · | 23 | 4 | · | · | · | · | · | **87** |
| **M7** | · | · | · | 2 | · | 2 | · | 2 | · | 10 | · | · | · | 3 | · | · | · | 2 | 6 | 11 | 27 | · | 1 | **66** |
| **Total** | **19** | **39** | **11** | **23** | **52** | **18** | **13** | **9** | **11** | **12** | **2** | **11** | **8** | **103** | **30** | **50** | **23** | **56** | **6** | **11** | **29** | **51** | **2** | **589** |
...
- **field** (20): `T-105` NF-A.H2 (2) · `T-106` NF-A.H3 (1) · `T-107` NF-A.H4 (2) · `T-108` NF-A.H5 (1) · `T-109` NF-A.H6 (2) · `T-110` NF-A.H7 (2) · `T-111` NF-A.H8 (3) · `T-112` NF-A.H9 (2) · `T-113` NF-A.H10 (2) · `T-124` NF-B.H1 (3)
...
- **field** (9): `T-125` NF-B.H2 (2) · `T-126` NF-B.H3 (3) · `T-184` OP-C.H2 (3) · `T-049` PF-E.H1 (1)
...
- **fe-nur** (5): `T-125` NF-B.H2 (1) · `T-126` NF-B.H3 (1) · `T-127` NF-B.U1 (1) · `T-128` R-SAFETY-ESC (2)
- **fe-adm** (43): `T-161` OP-A.H1 (1) · `T-162` OP-A.H2 (1) · `T-163` OP-A.H3 (2) · `T-164` OP-A.H4 (2) · `T-165` OP-A.H5 (2) · `T-166` OP-A.H6 (2) · `T-167` OP-A.H7 (1) · `T-168` OP-A.H8 (2) · `T-169` OP-A.H9 (2) · `T-170` OP-A.U1 (1) · `T-171` OP-A.U2 (1) · `T-172` R-ROLE-FIX (1) · `T-173` R-CAPACITY (2) · `T-183` OP-C.H1 (2) · `T-184` OP-C.H2 (2) · `T-185` OP-D.H1 (1) · `T-186` OP-D.H2 (1) · `T-187` OP-D.H3 (2) · `T-188` OP-D.H4 (2) · `T-189` OP-D.H5 (2) · `T-190` OP-D.H6 (2) · `T-191` OP-D.H7 (1) · `T-192` OP-D.U1 (1) · `T-193` OP-D.U2 (1) · `T-194` OP-D.U3 (1) · `T-195` R-CHARGEBACK (2) · `T-196` R-SETTLE-RETRY (2) · `T-197` R-BULK-RETRY (1)

### M5 — 87 pts

- **patient** (3): `T-060` PF-F.H1 (3)
- **prov** (2): `T-050` PF-E.H2 (1) · `T-134` NF-C.H6 (1)
- **field** (23): `T-051` PF-E.H3 (2) · `T-052` PF-E.H4 (2) · `T-053` PF-E.H5 (2) · `T-054` PF-E.H6 (1) · `T-055` PF-E.H7 (1) · `T-057` PF-E.H9 (4) · `T-129` NF-C.H1 (1) · `T-130` NF-C.H2 (1) · `T-131` NF-C.H3 (3) · `T-133` NF-C.H5 (2) · `T-174` OP-B.H1 (2) · `T-176` OP-B.H3 (2)
- **pay** (2): `T-136` NF-C.H8 (1) · `T-137` NF-C.H9 (1)
- **notif** (4): `T-056` PF-E.H8 (2) · `T-135` NF-C.H7 (2)
- **gw** (4): `T-177` OP-B.H4 (2) · `T-178` OP-B.H5 (2)
- **fe-pat** (21): `T-050` PF-E.H2 (1) · `T-051` PF-E.H3 (2) · `T-052` PF-E.H4 (1) · `T-053` PF-E.H5 (1) · `T-054` PF-E.H6 (3) · `T-055` PF-E.H7 (1) · `T-057` PF-E.H9 (2) · `T-058` PF-E.U1 (1) · `T-059` PF-E.U2 (1) · `T-060` PF-F.H1 (1) · `T-061` PF-F.U1 (1) · `T-062` R-CLINICAL-ESC (3) · `T-129` NF-C.H1 (3)
...
- **fe-adm** (7): `T-177` OP-B.H4 (2) · `T-178` OP-B.H5 (1) · `T-179` OP-B.U1 (1) · `T-180` OP-B.U2 (1) · `T-181` R-GEOCODE-MANUAL (1) · `T-182` R-INCIDENT-TRIAGE (1)
...
- **crm** (2): `T-069` PF-G.H7 (2)
- **fe-pat** (8): `T-063` PF-G.H1 (1) · `T-064` PF-G.H2 (1) · `T-065` PF-G.H3 (1) · `T-066` PF-G.H4 (1) · `T-067` PF-G.H5 (2) · `T-068` PF-G.H6 (1) · `T-069` PF-G.H7 (1)
...
- **fe-adm** (4): `T-157` PH-B.H1 (2) · `T-158` PH-B.H2 (2)
...
- **crm** (10): `T-202` AF-A.H1 (1) · `T-203` AF-A.H2 (2) · `T-205` AF-A.H4 (2) · `T-198` CS-A.H1 (3) · `T-199` CS-A.H2 (2)
- **fe-pat** (3): `T-070` PF-G.H8 (1) · `T-071` PF-G.H9 (1) · `T-072` PF-G.U1 (1)
