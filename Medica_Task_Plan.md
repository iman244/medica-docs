...
**Totals: 583 points** across 245 tasks — happy 400 · unhappy 60 · recovery 72 · devops 51.
...
### `T-051` · `PF-E.H3` Confirm or change the time — **4 pts**
...
### `T-057` · `PF-E.U1` Patient not home / unreachable — **1 pt**
*unhappy · at PF-E.H3 · resolved by `R-RESCHEDULE`*

### `T-058` · `PF-E.U2` Live tracking unavailable — **1 pt**
*unhappy · at PF-E.H6 · resolved by `R-TRACK-FALLBACK`*

## PF-F · Side-effect report — 8 pts

### `T-059` · `PF-F.H1` Report a side effect — **4 pts**
...
### `T-060` · `PF-F.U1` Urgent side effect — **1 pt**
*unhappy · at PF-F.H1 · resolved by `R-CLINICAL-ESC`*

### `T-061` · `R-CLINICAL-ESC` Urgent side-effect clinical escalation — **3 pts**
*recovery (recovery flow, clinical)*

## PF-G · Engagement & support — 30 pts

### `T-062` · `PF-G.H1` Adherence chart + streak — **2 pts**
...
### `T-063` · `PF-G.H2` Weight goal — **3 pts**
...
### `T-064` · `PF-G.H3` Daily reminders — **3 pts**
...
### `T-065` · `PF-G.H4` Content library — **3 pts**
...
### `T-066` · `PF-G.H5` Foodnoise tracking — **4 pts**
...
### `T-067` · `PF-G.H6` Multiple addresses + weight history — **3 pts**
...
### `T-068` · `PF-G.H7` Support chat + FAQ + emergency line — **3 pts**
...
### `T-069` · `PF-G.H8` Visit chat + survey + history PDF — **3 pts**
...
### `T-070` · `PF-G.H9` Pricing perks — **5 pts**
...
### `T-073` · `MF-A.H2` BMI calculator — **1 pts**
...
### `T-074` · `MF-A.H3` Public eligibility check (preliminary) — **4 pts**
...
### `T-075` · `MF-A.U1` Invalid BMI input — **1 pt**
*unhappy · at MF-A.H2 · resolved by `R-INLINE-VALIDATE`*

### `T-076` · `MF-A.U2` Not a fit / borderline — **1 pt**
*unhappy · at MF-A.H3 · resolved by `R-GUIDANCE-CTA`*

### `T-077` · `MF-A.U3` Preview unavailable — **1 pt**
*unhappy · at MF-A.H3 · resolved by `R-PREVIEW-RETRY`*

### `T-078` · `R-GUIDANCE-CTA` Supportive guidance + sign-up CTA — **1 pts**
*recovery (UI handling)*

### `T-079` · `R-PREVIEW-RETRY` Retry / proceed to full check — **1 pts**
*recovery (UI handling)*

## DF-A · Online visit & prescription — 27 pts

### `T-080` · `DF-A.H1` Open the assigned patient list — **2 pts**
...
### `T-081` · `DF-A.H2` Open a patient profile + EMR — **3 pts**
...
### `T-082` · `DF-A.H3` Conduct the phone visit — **0 pts**
*happy · depends on: DF-A.H2 · STEP-3B-03*
- reuses build of STEP-3B-03

### `T-083` · `DF-A.H4` Write the SOAP note — **4 pts**
...
### `T-084` · `DF-A.H5` Link the external prescription — **4 pts**
...
### `T-085` · `DF-A.H6` Confirm prescription status — **3 pts**
...
### `T-086` · `DF-A.H7` Auto-schedule the next visit — **4 pts**
...
### `T-087` · `DF-A.H8` External e-prescription integration goes live — **3 pts**
...
### `T-088` · `DF-A.U1` Record incomplete at visit — **1 pt**
*unhappy · at DF-A.H2 · resolved by `R-COMPLETE-RECORD`*

### `T-089` · `DF-A.U2` Rx rejected / invalid — **1 pt**
*unhappy · at DF-A.H5 · resolved by `R-RXFIX`*

### `T-090` · `DF-A.U3` Rx provider unreachable — **1 pt**
*unhappy · at DF-A.H5 · resolved by `R-RXFIX`*

### `T-091` · `R-COMPLETE-RECORD` Prompt to complete record — **1 pts**
*recovery (UI handling)*

## DF-B · Doctor panel & finance — 24 pts

### `T-092` · `DF-B.H1` Doctor login — **1 pts**
...
### `T-093` · `DF-B.H2` Doctor dashboard — **3 pts**
...
### `T-094` · `DF-B.H3` Patient management — **4 pts**
...
### `T-095` · `DF-B.H4` Doctor scheduling — **4 pts**
...
### `T-096` · `DF-B.H5` Doctor visits list — **2 pts**
...
### `T-097` · `DF-B.H6` Doctor prescriptions list — **2 pts**
...
### `T-098` · `DF-B.H7` Doctor financial panel — **3 pts**
...
### `T-099` · `DF-B.U1` Provider deactivated — **1 pt**
*unhappy · at DF-B.H1 · resolved by `R-REASSIGN`*

### `T-100` · `DF-B.U2` Nothing assigned yet — **1 pt**
*unhappy · at DF-B.H2 · resolved by `R-EMPTY-STATE`*

### `T-101` · `DF-B.U3` Assignment lost mid-care — **1 pt**
*unhappy · at DF-B.H3 · resolved by `R-REASSIGN`*

### `T-102` · `R-REASSIGN` Provider reassignment / in-flight care — **2 pts**
*recovery (recovery flow)*

## NF-A · Home-visit safety sequence — 44 pts

### `T-103` · `NF-A.H1` Nurse logs in — **4 pts**
...
### `T-104` · `NF-A.H2` Nurse dashboard & status — **4 pts**
...
### `T-105` · `NF-A.H3` View route & schedule (today / tomorrow / week) — **2 pts**
...
### `T-106` · `NF-A.H4` GPS check-in at the patient's location — **3 pts**
...
### `T-107` · `NF-A.H5` View patient profile + today's dose — **2 pts**
...
### `T-108` · `NF-A.H6` Record cold-chain temperature — **3 pts**
...
### `T-109` · `NF-A.H7` Pre-injection assessment — **4 pts**
...
### `T-110` · `NF-A.H8` Scan vial, then record injection site — **4 pts**
...
### `T-111` · `NF-A.H9` Patient signs — **3 pts**
...
### `T-112` · `NF-A.H10` Submit the visit — **3 pts**
...
### `T-113` · `NF-A.U1` GPS fails / location off — **1 pt**
*unhappy · at NF-A.H4 · resolved by `R-GPS-OVERRIDE`*

### `T-114` · `NF-A.U2` Patient not home / refuses / unsafe — **1 pt**
*unhappy · at NF-A.H5 · resolved by `R-RESCHEDULE`*

### `T-115` · `NF-A.U3` Cold-chain breach → do not administer — **1 pt**
*unhappy · at NF-A.H6 · resolved by `R-REPLACE`*

### `T-116` · `NF-A.U4` Wrong / mismatched vial scanned — **1 pt**
*unhappy · at NF-A.H8 · resolved by `R-VIAL-RESCAN`*

### `T-117` · `NF-A.U5` Signature capture fails / patient can't sign — **1 pt**
*unhappy · at NF-A.H9 · resolved by `R-OTP-RECEIPT`*

### `T-118` · `NF-A.U6` Offline mid-visit — **1 pt**
*unhappy · any step · resolved by `R-OFFLINE-CAPTURE`*

### `T-119` · `R-GPS-OVERRIDE` Manual GPS override — **1 pts**
*recovery (UI handling)*

### `T-120` · `R-VIAL-RESCAN` Wrong/mismatched vial — **3 pts**
*recovery (recovery flow, clinical)*

### `T-121` · `R-OTP-RECEIPT` OTP receipt fallback — **1 pts**
*recovery (UI handling)*

### `T-122` · `R-OFFLINE-CAPTURE` Offline capture + sync — **1 pts**
*recovery (UI handling)*

## NF-B · Safety & emergency — 14 pts

### `T-123` · `NF-B.H1` Escalate an emergency — **4 pts**
...
### `T-124` · `NF-B.H2` Press the safety button — **3 pts**
...
### `T-125` · `NF-B.H3` Emergency escalation in-software, routed to CS — **4 pts**
...
### `T-126` · `NF-B.U1` Safety button pressed — **1 pt**
*unhappy · at NF-B.H2 · resolved by `R-SAFETY-ESC`*

### `T-127` · `R-SAFETY-ESC` Nurse safety escalation — **2 pts**
*recovery (recovery flow)*

## NF-C · Route, inventory & completion — 32 pts

### `T-128` · `NF-C.H1` Live tracking + ETA — **6 pts**
...
### `T-129` · `NF-C.H2` Assigned-patient list — **2 pts**
...
### `T-130` · `NF-C.H3` Nurse inventory — **5 pts**
...
### `T-131` · `NF-C.H4` Reorder / reschedule — **1 pts**
*happy · depends on: NF-C.H3 · STEP-5-13*
- **nurse app** · frontend (`mfe-nurse`)
  - `CMP-NUR-024` · VisitReorder — reorder **(1 pt)**

### `T-132` · `NF-C.H5` Record patient education — **3 pts**
...
### `T-133` · `NF-C.H6` Week/month summary — **2 pts**
...
### `T-134` · `NF-C.H7` Support inbox — **3 pts**
...
### `T-135` · `NF-C.H8` Nurse financial panel — **3 pts**
...
### `T-136` · `NF-C.H9` Performance + hotline — **4 pts**
...
### `T-137` · `NF-C.U1` Route unavailable / Optime down — **1 pt**
*unhappy · at NF-C.H1 · resolved by `R-TRACK-FALLBACK`*

### `T-138` · `NF-C.U2` Shortage at pickup / count mismatch — **1 pt**
*unhappy · at NF-C.H3 · resolved by `R-STOCKOUT`*

### `T-139` · `NF-C.U3` No visits / patients / inventory — **1 pt**
*unhappy · at NF-C.H9 · resolved by `R-EMPTY-STATE`*

## PH-A · Inventory & dispense — 30 pts

### `T-140` · `PH-A.H1` Pharmacy login (OTP) — **4 pts**
...
### `T-141` · `PH-A.H2` Inventory dashboard — **3 pts**
...
### `T-142` · `PH-A.H3` Record supplier receipt — **3 pts**
...
### `T-143` · `PH-A.H4` Monitor cold chain — **3 pts**
...
### `T-144` · `PH-A.H5` Dispense to nurse — **3 pts**
...
### `T-145` · `PH-A.H6` Report damage — **3 pts**
...
### `T-146` · `PH-A.H7` View audit log — **2 pts**
...
### `T-147` · `PH-A.H8` Pharmacy commission — **0 pts**
*happy · depends on: PH-A.H7 · STEP-6-07*
- reuses build of STEP-6-07

### `T-148` · `PH-A.U1` No inventory / no pending dispenses — **1 pt**
*unhappy · at PH-A.H2 · resolved by `R-EMPTY-STATE`*

### `T-149` · `PH-A.U2` Hub cold-chain breach — **1 pt**
*unhappy · at PH-A.H4 · resolved by `R-HUB-QUARANTINE`*

### `T-150` · `PH-A.U3` Barcode scan fails — **1 pt**
*unhappy · at PH-A.H5 · resolved by `R-MANUAL-ENTRY`*

### `T-151` · `PH-A.U4` Stock-out / cannot fulfill — **1 pt**
*unhappy · at PH-A.H5 · resolved by `R-STOCKOUT`*

### `T-152` · `PH-A.U5` Expired stock detected — **1 pt**
*unhappy · at PH-A.H6 · resolved by `R-EXPIRE-QUARANTINE`*

### `T-153` · `R-HUB-QUARANTINE` Hub cold-chain quarantine — **2 pts**
*recovery (recovery flow)*

### `T-154` · `R-MANUAL-ENTRY` Manual barcode entry — **1 pts**
*recovery (UI handling)*

### `T-155` · `R-EXPIRE-QUARANTINE` Quarantine + replace expired stock — **1 pts**
*recovery (UI handling)*

## PH-B · Batch recall — 12 pts

### `T-156` · `PH-B.H1` Recall a batch — cascade to its vials — **5 pts**
...
### `T-157` · `PH-B.H2` Compute affected patients — **3 pts**
...
### `T-158` · `PH-B.U1` Batch recalled — **1 pt**
*unhappy · at PH-B.H1 · resolved by `R-RECALL`*

### `T-159` · `R-RECALL` Batch recall → reassign affected patients — **3 pts**
*recovery (recovery flow, clinical)*

## OP-A · Patients, providers & roles — 31 pts

### `T-160` · `OP-A.H1` List patients — **2 pts**
...
### `T-165` · `OP-A.H6` Onboard a provider (doctor / nurse) — **4 pts**
...
### `T-166` · `OP-A.H7` Verify credentials — **3 pts**
...
### `T-167` · `OP-A.H8` Assign a patient to a provider — **4 pts**
...
### `T-168` · `OP-A.H9` User management — **2 pts**
*happy · depends on: OP-A.H8 · STEP-8-01*
- **admin app** · frontend (`mfe-admin`)
  - `CMP-ADM-030` · UserManagement — users + activate **(2 pt)**

### `T-169` · `OP-A.U1` Role / permission misconfiguration — **1 pt**
*unhappy · at OP-A.H4 · resolved by `R-ROLE-FIX`*

### `T-170` · `OP-A.U2` No nurse available / no capacity — **1 pt**
*unhappy · at OP-A.H8 · resolved by `R-CAPACITY`*

### `T-171` · `R-ROLE-FIX` Role/permission correction — **1 pts**
*recovery (UI handling)*

### `T-172` · `R-CAPACITY` No nurse available / no capacity — **2 pts**
*recovery (recovery flow)*

## OP-B · Routing & fulfillment — 18 pts

### `T-173` · `OP-B.H1` Geocode the patient's address — **2 pts**
*happy · depends on: — · STEP-5-07*
- **`field` service** · backend
  - `API-FIELD-030` · POST /logistics/geocode — address → coords **(2 pt)**

### `T-174` · `OP-B.H2` Generate the optimized route — **2 pts**
*happy · depends on: OP-B.H1 · STEP-5-08*
- **nurse app** · frontend (`mfe-nurse`)
  - `CMP-NUR-020` · RouteMapOptimized — route + position **(2 pt)**

### `T-175` · `OP-B.H3` On-demand emergency assignment — **3 pts**
...
### `T-176` · `OP-B.H4` Operations dashboard — **4 pts**
...
### `T-177` · `OP-B.H5` Reschedule tool — **3 pts**
...
### `T-178` · `OP-B.U1` Geocode failed — **1 pt**
*unhappy · at OP-B.H1 · resolved by `R-GEOCODE-MANUAL`*

### `T-179` · `OP-B.U2` Incident / cold-chain network alert — **1 pt**
*unhappy · at OP-B.H4 · resolved by `R-INCIDENT-TRIAGE`*

### `T-180` · `R-GEOCODE-MANUAL` Manual geocode pin — **1 pts**
*recovery (UI handling)*

### `T-181` · `R-INCIDENT-TRIAGE` Incident triage — **1 pts**
*recovery (UI handling)*

## OP-C · Safety-critical recovery (control surface) — 11 pts

### `T-182` · `OP-C.H1` Monitor side-effect reports + assign a reviewer — **6 pts**
...
### `T-183` · `OP-C.H2` Open a replacement order — **5 pts**
...
### `T-184` · `OP-D.H1` Issue a refund — **4 pts**
...
### `T-185` · `OP-D.H2` Run monthly settlements — **5 pts**
...
### `T-186` · `OP-D.H3` Finance dashboard — **3 pts**
...
### `T-187` · `OP-D.H4` Growth dashboard — **3 pts**
...
### `T-188` · `OP-D.H5` Campaign manager — **5 pts**
...
### `T-190` · `OP-D.H7` Reports + export — **2 pts**
...
### `T-191` · `OP-D.U1` Refund / chargeback edge — **1 pt**
*unhappy · at OP-D.H1 · resolved by `R-CHARGEBACK`*

### `T-192` · `OP-D.U2` Settlement run fails / partial — **1 pt**
*unhappy · at OP-D.H2 · resolved by `R-SETTLE-RETRY`*

### `T-193` · `OP-D.U3` Bulk action partial failure — **1 pt**
*unhappy · at OP-D.H5 · resolved by `R-BULK-RETRY`*

### `T-194` · `R-CHARGEBACK` Chargeback reconciliation — **2 pts**
*recovery (recovery flow)*

### `T-195` · `R-SETTLE-RETRY` Settlement-run failure — **2 pts**
*recovery (recovery flow)*

### `T-196` · `R-BULK-RETRY` Per-row retry — **1 pts**
*recovery (UI handling)*

## CS-A · CS console — 11 pts

### `T-197` · `CS-A.H1` Call console + routing — **5 pts**
...
### `T-198` · `CS-A.H2` Six CS sub-panels, scoped per panel — **4 pts**
...
### `T-202` · `AF-A.H2` Referral links + conversion — **3 pts**
...
### `T-203` · `AF-A.H3` Affiliate onboarding + codes + audit — **3 pts**
...
### `T-204` · `AF-A.H4` Commission + payment — **4 pts**
...
### `T-205` · `AF-A.H5` A/B experiments — **1 pts**
*happy · depends on: AF-A.H4 · STEP-9-14*
- (no API/component — config / integration step)

### `T-206` · `AF-A.U1` Referral link invalid / expired — **1 pt**
*unhappy · at AF-A.H2 · resolved by `R-NEW-LINK`*

### `T-207` · `AF-A.U2` Application rejected — **1 pt**
*unhappy · at AF-A.H3 · resolved by `R-BLOCKED-STATE`*

### `T-208` · `AF-A.U3` Commission dispute / not yet payable — **1 pt**
*unhappy · at AF-A.H4 · resolved by `R-CS-TICKET`*

### `T-209` · `R-NEW-LINK` Issue a fresh referral link — **1 pts**
*recovery (UI handling)*

### `T-210` · `R-CS-TICKET` Generic CS ticket — **1 pts**
*recovery (UI handling)*

## XF · Cross-cutting failures — 14 pts

### `T-211` · `XF.U1` Network offline — **1 pt**
*unhappy · any step · resolved by `R-OFFLINE-BANNER`*

### `T-212` · `XF.U2` Session expired / token invalid — **1 pt**
*unhappy · any step · resolved by `R-REAUTH`*

### `T-213` · `XF.U3` Permission denied (403) — **1 pt**
*unhappy · any step · resolved by `R-NO-ACCESS`*

### `T-214` · `XF.U4` Not found (404) / deleted — **1 pt**
*unhappy · any step · resolved by `R-NOT-FOUND`*

### `T-215` · `XF.U5` Server / dependent-service error (5xx) — **1 pt**
*unhappy · any step · resolved by `R-RETRY-5XX`*

### `T-216` · `XF.U6` Rate limited (429) — **1 pt**
*unhappy · any step · resolved by `R-RATE-LIMIT`*

### `T-217` · `XF.U7` Stale data / concurrent edit conflict — **1 pt**
*unhappy · any step · resolved by `R-CONFLICT`*

### `T-218` · `R-OFFLINE-BANNER` Offline banner — **1 pts**
*recovery (UI handling)*

### `T-219` · `R-REAUTH` Re-authenticate — **1 pts**
*recovery (UI handling)*

### `T-220` · `R-NO-ACCESS` Permission-denied state — **1 pts**
*recovery (UI handling)*

### `T-221` · `R-NOT-FOUND` Not-found state — **1 pts**
*recovery (UI handling)*

### `T-222` · `R-RETRY-5XX` Server-error retry — **1 pts**
*recovery (UI handling)*

### `T-223` · `R-RATE-LIMIT` Rate-limit wait — **1 pts**
*recovery (UI handling)*

### `T-224` · `R-CONFLICT` Concurrent-edit conflict — **1 pts**
*recovery (UI handling)*
...
### `T-225` · `R-RESCHEDULE` Reschedule a missed/aborted visit — **2 pts**
*recovery (recovery flow) · shared*

### `T-226` · `R-RXFIX` External Rx re-issue + re-link — **2 pts**
*recovery (recovery flow) · shared*

### `T-227` · `R-REPLACE` Replacement-dose order — **3 pts**
*recovery (recovery flow, clinical) · shared*

### `T-228` · `R-STOCKOUT` Stock-out / shortage at pickup — **2 pts**
*recovery (recovery flow) · shared*

### `T-229` · `R-BLOCKED-STATE` Full-screen blocked/rejected state — **1 pts**
*recovery (UI handling) · shared*

### `T-230` · `R-INLINE-VALIDATE` Inline validation + retry — **1 pts**
*recovery (UI handling) · shared*

### `T-231` · `R-EMPTY-STATE` Designed empty state — **1 pts**
*recovery (UI handling) · shared*

### `T-232` · `R-TRACK-FALLBACK` Tracking fallback — **1 pts**
*recovery (UI handling) · shared*
...
- **`T-233`** · `DVO-K8S-DEV` Kubernetes — dev stage — provision dev cluster, namespaces, RBAC, quotas **(4 pts)**
- **`T-234`** · `DVO-K8S-PROD` Kubernetes — prod stage — HA prod cluster, network policies, quotas, pod security **(6 pts)**
- **`T-235`** · `DVO-CHARTS` Service deploy template (Helm/Kustomize) — Deployment+Service+HPA+probes+config/secret, reused by ~10 services & 9 MFEs **(6 pts)**
- **`T-236`** · `DVO-INGRESS` Ingress / gateway + TLS — path routing per surface, cert-manager TLS **(3 pts)**
- **`T-237`** · `DVO-SECRETS` Secrets & config management — sealed-secrets/Vault, per-env config **(3 pts)**

### CI/CD & GitOps

- **`T-238`** · `DVO-CI` CI pipeline — lint, tests, image build & push **(4 pts)**
- **`T-239`** · `DVO-CD` CD wiring — image tag → manifest bump **(3 pts)**
- **`T-240`** · `DVO-ARGOCD` ArgoCD (GitOps delivery) — app-of-apps + per-env (dev/prod) + sync/rollback **(5 pts)**

### Observability

- **`T-241`** · `DVO-METRICS` VictoriaMetrics (metrics) — TSDB + vmagent + vmalert **(4 pts)**
- **`T-242`** · `DVO-GRAFANA` Grafana (dashboards) — datasources, per-service dashboards, SLOs **(4 pts)**
- **`T-243`** · `DVO-OTEL` OpenTelemetry (tracing) — collector + instrumentation hooks **(3 pts)**
- **`T-244`** · `DVO-ALERTS` Alerting — Alertmanager routing + on-call **(3 pts)**
- **`T-245`** · `DVO-LOKI` Loki (logging) — Loki + promtail, retention, dashboards **(3 pts)**
